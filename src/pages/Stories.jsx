      ...
      <div className="fixed top-1/2 -translate-y-1/2 left-4 md:left-6 z-40 flex flex-col pointer-events-none">
        <div className="bg-white/70 backdrop-blur-md p-1.5 rounded-3xl shadow-md flex flex-col gap-2 pointer-events-auto border border-white/40">
          <button
            ...
            className={`relative px-4 py-3 rounded-2xl font-medium transition-colors z-10 flex flex-col items-center gap-1 ${activeTab === "images" ? "text-white" : "text-gray-700 hover:text-black"
              }`}
          >
            {activeTab === "images" && (
              <motion.div
          ...
          <button
            ...
            className={`relative px-4 py-3 rounded-2xl font-medium transition-colors z-10 flex flex-col items-center gap-1 ${activeTab === "videos" ? "text-white" : "text-gray-700 hover:text-black"
              }`}
          >
            {activeTab === "videos" && (
              <motion.div
